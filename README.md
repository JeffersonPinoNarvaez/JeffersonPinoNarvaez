...
- **Cloud & Infra:** AWS, Docker, Kubernetes, Vagrant, Linux  
...
- 📦 **Vagrant Webservices Cluster**  
  ...
  - Production-style distributed system with load balancing and reproducible environments  

- 🪄 **Invisibility Cloak – YOLOv8**  
  - Repo: https://github.com/JeffersonPinoNarvaez/invisibility-cloak-yolov8  
  - Real-time computer vision experiment using modern AI techniques  
...
- Main Languages: Shell, Python, JavaScript  
- Focus Areas: Cloud Systems, AI Applications, Infrastructure Automation  
...
- Portfolio: https://jeffersonpino.dev 
- LinkedIn: https://www.linkedin.com/in/jefferson-pino-narvaez/
